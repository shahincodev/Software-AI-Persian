...
۸. **🔄 Phase 8 — تاب‌آوری خطا و بهینه‌سازی زنجیره Failover**: اصلاح ورودی کاربر، circuit breaker برای مدل‌های 403، مدیریت هوشمند ارائه‌دهندگان.
۹. **📋 Phase 9 — بهینه‌سازی عملکرد و تجربه کاربری**: کش پاسخ‌های AI، بهبود CLI، تست‌های یکپارچه‌سازی.
...
| `ROADMAP.md` | نقشه راه توسعه (فاز ۱ تا ۱۰ — فاز ۱ تا ۷ تکمیل شده) |
