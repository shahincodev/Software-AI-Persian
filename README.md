...
| **سیستم حافظه** | ✅ فعال | حافظه کوتاه‌مدت (مبتنی بر TTL) و بلندمدت (SQLite) با ابزارهای remember/recall/forget |
...
| `docs/PHASE4_MULTI_STEP_PLANNING_REPORT.md` | گزارش کامل Phase 4 — برنامه‌ریزی چندمرحله‌ای هوشمند |
| `docs/PHASE5_PERSISTENT_MEMORY_REPORT.md` | گزارش کامل Phase 5 — حافظه پایدار |
